export const rnProject = [
  {
    period: "2020.08 ~ 2020.12",
    title: "MBTI 대학생 미팅어플",
    content: [
      "MBTI, 별자리, 띠등의 정보를 활용하여 이성과의 궁합도를 제공해주는 색다른 미팅어플.",
      "본인의 사진 대신 머신러닝을 통하여 닮은 동물을 찾아주어 프로필사진을 등록.",
      "신뢰성을 위해 대학교 인증 시스템과 안전귀가서비스 기능 도입.",
      "프로젝트는 3명이 프론트, 서버, 머신러닝으로 나누어 구현.",
  ...
  },
  {
    ...
    content: [
      "처음 ReactNative를 공부하며 3명이서 함께 만들어본 주변 식당 랜덤 추천 어플.",
      "다음 API와 연동하여 현재 위치에서 주위의 식당의 정보를 받는 Rest API 사용과 Admob을 이용하여 광고 구현.",
    ],
